...
#define dept_write_lock(m, ne, e_fn, ip)		dept_wait_ecxt_enter(m, DEPT_EVT_RW, DEPT_EVT_W, ip, __func__, __func__, e_fn, ne)
#define dept_write_trylock(m, e_fn, ip)		dept_ecxt_enter(m, DEPT_EVT_W, ip, __func__, e_fn, 0)
#define dept_read_lock(m, ne, e_fn, ip, q)	dept_wait_ecxt_enter(m, (q) ? DEPT_EVT_RW : DEPT_EVT_W, DEPT_EVT_R, ip, __func__, __func__, e_fn, ne)
...
#define dept_write_lock(m, ne, e_fn, ip)		do { } while (0)
#define dept_write_trylock(m, e_fn, ip)		do { } while (0)
#define dept_read_lock(m, ne, e_fn, ip, q)	do { } while (0)
